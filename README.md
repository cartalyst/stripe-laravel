...
Reader-friendly Documentation can be found here. [Stripe Laravel Manual](https://cartalyst.com/manual/stripe-laravel/2.0) and [Stripe Manual](https://cartalyst.com/manual/stripe/1.0).
